...
select min(period_diff(date_format(curdate(), "%Y%m"), date_format(birth_date, "%Y%m")) div 12),
	max(period_diff(date_format(curdate(), "%Y%m"), date_format(birth_date, "%Y%m")) div 12)
from employees;